    ...
    return (
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="text-center space-y-3">
          ...
          <Button variant="outline" onClick={() => router.push('/llm-providers')}>
  ...
  return (
    <div className="flex-1 space-y-6 p-4 md:p-8 pt-6 bg-background max-w-2xl mx-auto">
      <div className="flex items-center gap-3">
        <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => router.push('/llm-providers')}>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Link href={`/llm-providers/${provider.id}/edit`}>
